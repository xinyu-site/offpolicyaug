...
def get_config():
    ...
    parser.add_argument('--user_name', type=str, default="buaa_yuxin")
    ...
    parser.add_argument('--log_interval', type=int, default=1000,
                        help="After how many steps of training the policy Q should be loged")

    # pretained parameters
    parser.add_argument("--model_dir", type=str, default=None)
    
    # sym_los parameters
    parser.add_argument("--use_sym_loss", action='store_false', default=True)
    parser.add_argument('--sym_ipt', type=float, default=0.05, help="sym imp rate")
    
    # data_aug
    parser.add_argument("--data_aug",  action='store_false', default=True)
    parser.add_argument("--use_ucb", default=False, help="Use ucb to select data augmentation or not")
    parser.add_argument("--first_aug", default=0, type=int, help="Set the first ucb arm value(0~9), -1 represents not selecting")
    parser.add_argument("--second_aug", default=-1, type=int, help="Set the second ucb arm value, -1 represents not selecting")
    parser.add_argument("--coef", default=1.0, help="Exploration coefficient")
    parser.add_argument("--period", default=0, help="The period to reset the ucb-arm value, 0 means no reset")
    parser.add_argument("--winL", default=50, help="Length of ucb window")
