...
def main(args):
    ...
    # np.save('originQ.npy', np.array(runner.origin_qval))
    # with open('/results/ucb/ucb2_10w.json', 'w') as f:
    #     f.write(json.dumps(runner.selected_ucb))
    #     f.close()
    env.close()
...
if __name__ == "__main__":
    sys.argv = ['CUDA_VISIBLE_DEVICES=2',
